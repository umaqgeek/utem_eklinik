...
public class Report5 {
    ...
    public static void main(String[] args) {
        ...
        String[] Faculty={"FTMK","FTK"};//--------------> (temporarily) will update base on user selected
        int i = 0;
        int Total = 0;
        ...
        try {
            ...
            Connection conn = DriverManager.getConnection(connectionURL);
                ...
                //String query = "SELECT Medication_code, Medication_desc, COUNT(*) as PatientTotal FROM servercis.lhr_medication WHERE LOCATION_CODE="+ Faculty[i] +" group by LOCATION_CODE, Medication_code ;";
                String query = "SELECT LOCATION_CODE, Medication_code, Medication_desc, COUNT(Medication_code) as PatientTotal FROM servercis.lhr_medication group by LOCATION_CODE, Medication_code;";
